...
<%@ Register Assembly="DevExpress.Web.v13.2, Version=13.2.11.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
            ...
            <tr>
                ...
                <td>
                    <div class="menuDiv" id="menuDiv">
                        <dx:ASPxMenu ID="ASPxMenu1" runat="server" Orientation="Horizontal" Height="40px" Width="100%">
                            <ItemStyle Width="200px" Paddings-PaddingTop="8px" Paddings-PaddingBottom="8px" />
                            <Items>
                                <dx:MenuItem Text="Item1">
                                    <Items>
                                        <dx:MenuItem Text="SubItem1">
                                        </dx:MenuItem>
                                        <dx:MenuItem Text="SubItem2">
                                        </dx:MenuItem>
                                    </Items>
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item1">
                                ...
                                <dx:MenuItem Text="Item4">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item5">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item6">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item7">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item8">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item9">
                                </dx:MenuItem>
                                ...
                                <dx:MenuItem Text="Item11">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item12">
                                </dx:MenuItem>
                                <dx:MenuItem Text="Item13">
                                </dx:MenuItem>
                            </Items>
                        </dx:ASPxMenu>
                    </div>
